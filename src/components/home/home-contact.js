      ...
      >
        <div className="flex flex-col col-span-7 gap-10 max-md:order-2 max-md:gap-5 max-sm:gap-3 max-md:col-span-full">
          ...
          <p className="text-lg max-md:text-base max-sm:text-sm text-[#717171]">
            نحن هنا لخدمة المجتمع وتقديم الدعم والمساعدة لمن هم في حاجة. يسعدنا
            أن نتواصل معكم لتقديم معلومات حول خدماتنا ومبادراتنا أو للإجابة على
            استفساراتكم. بإمكانكم الوصول إلينا عبر قنوات التواصل المتاحة، سواءً
            من خلال الهاتف، البريد الإلكتروني، أو وسائل التواصل الاجتماعي.
          </p>
