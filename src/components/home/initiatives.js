          ...
          <div className="flex flex-col gap-8 max-md:gap-4">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-lg max-md:text-base max-sm:text-sm leading-loose text-[#717171]">
                ...
                المستدامة لأفراده، من خلال دعم المبادرات التي تساهم في تحسين
                جودة الحياة والتركيز على تعزيز الابتكار والتميز.
              </p>
              <p className="text-lg max-md:text-base max-sm:text-sm leading-loose text-[#717171]">
                وذلك لإيمان مؤسسة الوليد بن حمد آل مبارك الأهلية {'"أهم"'}{" "}
                بأهداف ومخرجات هذا البرنامج وما سيحدثه من أثر في تطوير المتدربين
                وفق أحدث تقنيات الإعلام المواكب، وإتاحة فرص التأهيل للصحفيين
                والإعلاميين السعوديين، للمساهمة في تطوير الإعلام السعودي ليواكب
                برامج التنمية الشاملة التي تعيشها بلادنا الغالية، خاصة وأن تنظيم
                هذه المبادرة يأتي من جهات إعلامية عريقة، لها تاريخ ممتد وتراكم
                خبرات في قطاع الصحافة والإعلام، وهي معهد دار اليوم، وهيئة
                الصحفيين السعوديين.
              </p>
            </div>
          </div>
